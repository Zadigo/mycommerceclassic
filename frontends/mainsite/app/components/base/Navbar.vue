<template>
  <nav class="h-17.5 relative w-full px-6 md:px-16 lg:px-24 xl:px-32 flex items-center justify-between z-40 bg-white dark:bg-slate-900 text-slate-700 shadow-md transition-all">
    ...
    <ul class="md:flex hidden items-center gap-10">
      <li>
        <lazy-base-ecommerce-menu hydrate-on-idle>
          <template #default="props">
            <u-button v-bind="props" variant="soft" color="neutral" size="xl">
              Femmes
            </u-button>
          </template>
    ...
    <div class="flex gap-2">
      <lazy-u-drawer title="Rechercher des produits" :handle="false" should-scale-background set-background-color-on-scale hydrate-on-visible>
        ...
        <template #content>
          <lazy-base-search-block :hydrate-after="100" />
        </template>
      </lazy-u-drawer>
