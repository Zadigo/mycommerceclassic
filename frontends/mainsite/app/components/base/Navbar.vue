<template>
  <nav class="h-17.5 relative w-full px-6 md:px-16 lg:px-24 xl:px-32 flex items-center justify-between z-20 bg-primary-50 text-gray-700 shadow-md transition-all">
